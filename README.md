...
> **MINIMAX H3**：单次生成约 ≤15 秒。网页时间轴超过 15s 会自动拆成多条各自 ≤15s 的任务，不要按 20–30s 一次生成来用。
...
仅限 **21 岁及以上**虚构成人内容。允许成人间 CNC/强制/轮奸/调教/迷奸等**虚构暗黑幻想**；禁止未成年、年龄模糊、真实名人、虐杀/极端血腥、兽交。本仓库只提供提示词工具与文本模块，不托管色情媒体。
